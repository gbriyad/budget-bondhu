...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { discount_price: @price.discount_price, original_price: @price.original_price, product_id: @price.product_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { discount_price: @price.discount_price, original_price: @price.original_price, product_id: @price.product_id } }
